...
public class AssetListEntryModelImpl extends BaseModelImpl<AssetListEntry>
	...
	public static final long ASSETLISTENTRYID_COLUMN_BITMASK = 16L;
	...
	public String[] getAvailableLanguageIds() {
		List<AssetListEntryLocalization> assetListEntryLocalizations = AssetListEntryLocalServiceUtil.getAssetListEntryLocalizations(getPrimaryKey());

		String[] availableLanguageIds = new String[assetListEntryLocalizations.size()];

		for (int i = 0; i < availableLanguageIds.length; i++) {
			AssetListEntryLocalization assetListEntryLocalization = assetListEntryLocalizations.get(i);

			availableLanguageIds[i] = assetListEntryLocalization.getLanguageId();
		}
	...
	public Map<String, String> getLanguageIdToTitleMap() {
		...
		for (AssetListEntryLocalization assetListEntryLocalization : assetListEntryLocalizations) {
			languageIdToTitleMap.put(assetListEntryLocalization.getLanguageId(),
				assetListEntryLocalization.getTitle());
		}
	...
	private String _getTitle(String languageId) {
		AssetListEntryLocalization assetListEntryLocalization = AssetListEntryLocalServiceUtil.fetchAssetListEntryLocalization(getPrimaryKey(),
				languageId);
		...
		return assetListEntryLocalization.getTitle();
	}
	...
	public Map<String, String> getLanguageIdToDescriptionMap() {
		...
		for (AssetListEntryLocalization assetListEntryLocalization : assetListEntryLocalizations) {
			languageIdToDescriptionMap.put(assetListEntryLocalization.getLanguageId(),
				assetListEntryLocalization.getDescription());
		}
	...
	private String _getDescription(String languageId) {
		...
		return assetListEntryLocalization.getDescription();
	}
	...
	public Object clone() {
		...
		assetListEntryImpl.setDefaultLanguageId(getDefaultLanguageId());
	...
	public CacheModel<AssetListEntry> toCacheModel() {
		...
		assetListEntryCacheModel.defaultLanguageId = getDefaultLanguageId();

		String defaultLanguageId = assetListEntryCacheModel.defaultLanguageId;

		if ((defaultLanguageId != null) && (defaultLanguageId.length() == 0)) {
			assetListEntryCacheModel.defaultLanguageId = null;
		}
