	...
	public static java.util.List<Object>
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				"getFragmentCompositionsAndEntriesByNameAndStatus",
				_getFragmentCompositionsAndEntriesByNameAndStatusParameterTypes7);
	...
	public static java.util.List<Object>
		...
		try {
			MethodKey methodKey = new MethodKey(
				FragmentEntryServiceUtil.class,
				"getFragmentCompositionsAndEntriesByStatus",
				_getFragmentCompositionsAndEntriesByStatusParameterTypes8);
	...
	public static int getFragmentCompositionsAndEntriesCountByNameAndStatus(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getFragmentCompositionsAndEntriesCountByNameAndStatusParameterTypes9);
	...
	public static int getFragmentCompositionsAndEntriesCountByStatus(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_getFragmentCompositionsAndEntriesCountByStatusParameterTypes10);
