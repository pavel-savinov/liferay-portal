...
import com.liferay.modern.site.building.fragment.exception.NoSuchEntryException;
import com.liferay.modern.site.building.fragment.model.FragmentEntry;
import com.liferay.modern.site.building.fragment.model.impl.FragmentEntryImpl;
import com.liferay.modern.site.building.fragment.model.impl.FragmentEntryModelImpl;
 ...
 * @see com.liferay.modern.site.building.fragment.service.persistence.FragmentEntryUtil
 * @generated
 */
@ProviderType
public class FragmentEntryPersistenceImpl extends BasePersistenceImpl<FragmentEntry>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((fragmentEntry.getUuid() == null) ||
							!fragmentEntry.getUuid().equals(uuid) ||
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_FC = new FinderPath(FragmentEntryModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_FC",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_FC = new FinderPath(FragmentEntryModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryModelImpl.FINDER_CACHE_ENABLED,
			FragmentEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_FC",
			...
			FragmentEntryModelImpl.FRAGMENTCOLLECTIONID_COLUMN_BITMASK |
			FragmentEntryModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_FC = new FinderPath(FragmentEntryModelImpl.ENTITY_CACHE_ENABLED,
			FragmentEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<FragmentEntry> findByG_FC(long groupId,
		long fragmentCollectionId) {
	 ...
	 */
	@Override
	public FragmentEntry findByG_FC_First(long groupId,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		FragmentEntry fragmentEntry = fetchByG_FC_First(groupId,
	 ...
	 */
	@Override
	public FragmentEntry fetchByG_FC_First(long groupId,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator) {
		List<FragmentEntry> list = findByG_FC(groupId, fragmentCollectionId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntry findByG_FC_Last(long groupId,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		FragmentEntry fragmentEntry = fetchByG_FC_Last(groupId,
				fragmentCollectionId, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntry fetchByG_FC_Last(long groupId,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator) {
		...
		List<FragmentEntry> list = findByG_FC(groupId, fragmentCollectionId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntry[] findByG_FC_PrevAndNext(long fragmentEntryId,
		...
		try {
			...
			array[0] = getByG_FC_PrevAndNext(session, fragmentEntry, groupId,
					fragmentCollectionId, orderByComparator, true);

			array[1] = fragmentEntry;

			array[2] = getByG_FC_PrevAndNext(session, fragmentEntry, groupId,
	...
	protected FragmentEntry getByG_FC_PrevAndNext(Session session,
	 ...
	 */
	@Override
	public List<FragmentEntry> filterFindByG_FC(long groupId,
		long fragmentCollectionId) {
		return filterFindByG_FC(groupId, fragmentCollectionId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<FragmentEntry> filterFindByG_FC(long groupId,
		long fragmentCollectionId, int start, int end) {
		return filterFindByG_FC(groupId, fragmentCollectionId, start, end, null);
	}
	 ...
	 */
	@Override
	public FragmentEntry[] filterFindByG_FC_PrevAndNext(long fragmentEntryId,
		long groupId, long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_FC_PrevAndNext(fragmentEntryId, groupId,
				fragmentCollectionId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_FC_PrevAndNext(session, fragmentEntry,
					groupId, fragmentCollectionId, orderByComparator, true);

			array[1] = fragmentEntry;

			array[2] = filterGetByG_FC_PrevAndNext(session, fragmentEntry,
	...
	protected FragmentEntry filterGetByG_FC_PrevAndNext(Session session,
		FragmentEntry fragmentEntry, long groupId, long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_FC(long groupId, long fragmentCollectionId) {
		for (FragmentEntry fragmentEntry : findByG_FC(groupId,
				fragmentCollectionId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(fragmentEntry);
		}
	}
	 ...
	 */
	@Override
	public int filterCountByG_FC(long groupId, long fragmentCollectionId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_FC(groupId, fragmentCollectionId);
		}
	...
	private static final String _FINDER_COLUMN_G_FC_GROUPID_2 = "fragmentEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_FC_FRAGMENTCOLLECTIONID_2 = "fragmentEntry.fragmentCollectionId = ?";
	...
	/**
	 * Returns all the fragment entries where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	 ...
	 */
	@Override
	public List<FragmentEntry> findByG_LikeN_FC(long groupId, String name,
		long fragmentCollectionId) {
	...
	/**
	 * Returns a range of all the fragment entries where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the fragment entries where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first fragment entry in the ordered set where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	 ...
	 */
	@Override
	public FragmentEntry findByG_LikeN_FC_First(long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		FragmentEntry fragmentEntry = fetchByG_LikeN_FC_First(groupId, name,
				fragmentCollectionId, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntry fetchByG_LikeN_FC_First(long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator) {
		List<FragmentEntry> list = findByG_LikeN_FC(groupId, name,
	...
	/**
	 * Returns the last fragment entry in the ordered set where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	 ...
	 */
	@Override
	public FragmentEntry findByG_LikeN_FC_Last(long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		FragmentEntry fragmentEntry = fetchByG_LikeN_FC_Last(groupId, name,
				fragmentCollectionId, orderByComparator);
	 ...
	 */
	@Override
	public FragmentEntry fetchByG_LikeN_FC_Last(long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator) {
	...
	/**
	 * Returns the fragment entries before and after the current fragment entry in the ordered set where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param fragmentEntryId the primary key of the current fragment entry
	 * @param groupId the group ID
	 * @param name the name
	 ...
	 */
	@Override
	public FragmentEntry[] findByG_LikeN_FC_PrevAndNext(long fragmentEntryId,
		long groupId, String name, long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		FragmentEntry fragmentEntry = findByPrimaryKey(fragmentEntryId);
		...
		try {
			...
			array[0] = getByG_LikeN_FC_PrevAndNext(session, fragmentEntry,
					groupId, name, fragmentCollectionId, orderByComparator, true);

			array[1] = fragmentEntry;

			array[2] = getByG_LikeN_FC_PrevAndNext(session, fragmentEntry,
	...
	protected FragmentEntry getByG_LikeN_FC_PrevAndNext(Session session,
		FragmentEntry fragmentEntry, long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Returns all the fragment entries that the user has permission to view where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	 ...
	 */
	@Override
	public List<FragmentEntry> filterFindByG_LikeN_FC(long groupId,
		String name, long fragmentCollectionId) {
		return filterFindByG_LikeN_FC(groupId, name, fragmentCollectionId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the fragment entries that the user has permission to view where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<FragmentEntry> filterFindByG_LikeN_FC(long groupId,
		String name, long fragmentCollectionId, int start, int end) {
		return filterFindByG_LikeN_FC(groupId, name, fragmentCollectionId,
			start, end, null);
	}

	/**
	 * Returns an ordered range of all the fragment entries that the user has permissions to view where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link FragmentEntryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the fragment entries before and after the current fragment entry in the ordered set of fragment entries that the user has permission to view where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param fragmentEntryId the primary key of the current fragment entry
	 * @param groupId the group ID
	 * @param name the name
	 ...
	 */
	@Override
	public FragmentEntry[] filterFindByG_LikeN_FC_PrevAndNext(
		long fragmentEntryId, long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator)
		throws NoSuchEntryException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_LikeN_FC_PrevAndNext(fragmentEntryId, groupId, name,
				fragmentCollectionId, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_LikeN_FC_PrevAndNext(session,
					fragmentEntry, groupId, name, fragmentCollectionId,
					orderByComparator, true);

			array[1] = fragmentEntry;

			array[2] = filterGetByG_LikeN_FC_PrevAndNext(session,
					fragmentEntry, groupId, name, fragmentCollectionId,
					orderByComparator, false);
	...
	protected FragmentEntry filterGetByG_LikeN_FC_PrevAndNext(Session session,
		FragmentEntry fragmentEntry, long groupId, String name,
		long fragmentCollectionId,
		OrderByComparator<FragmentEntry> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the fragment entries where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	...
	public void removeByG_LikeN_FC(long groupId, String name,
		long fragmentCollectionId) {
		for (FragmentEntry fragmentEntry : findByG_LikeN_FC(groupId, name,
				fragmentCollectionId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(fragmentEntry);
		}
	}
	...
	/**
	 * Returns the number of fragment entries where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	...
	/**
	 * Returns the number of fragment entries that the user has permission to view where groupId = &#63; and name LIKE &#63; and fragmentCollectionId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param name the name
	 * @param fragmentCollectionId the fragment collection ID
	 ...
	 */
	@Override
	public int filterCountByG_LikeN_FC(long groupId, String name,
		long fragmentCollectionId) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_LikeN_FC(groupId, name, fragmentCollectionId);
		}
	...
	private static final String _FINDER_COLUMN_G_LIKEN_FC_GROUPID_2 = "fragmentEntry.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_LIKEN_FC_NAME_1 = "fragmentEntry.name IS NULL AND ";
	private static final String _FINDER_COLUMN_G_LIKEN_FC_NAME_2 = "lower(fragmentEntry.name) LIKE ? AND ";
	private static final String _FINDER_COLUMN_G_LIKEN_FC_NAME_3 = "(fragmentEntry.name IS NULL OR fragmentEntry.name LIKE '') AND ";
	...
	protected FragmentEntry toUnwrappedModel(FragmentEntry fragmentEntry) {
		...
		fragmentEntryImpl.setUuid(fragmentEntry.getUuid());
