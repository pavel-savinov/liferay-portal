...
create unique index IX_35C89130 on GroupFriendlyURL (friendlyURL[$COLUMN_LENGTH:255$], languageId[$COLUMN_LENGTH:75$]);
create unique index IX_DC986B66 on GroupFriendlyURL (groupId, languageId[$COLUMN_LENGTH:75$]);
