...
public class AssetListEntryPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newAssetListEntry.setDefaultLanguageId(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingAssetListEntry.getDefaultLanguageId(),
			newAssetListEntry.getDefaultLanguageId());
	...
	protected OrderByComparator<AssetListEntry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("AssetListEntry", "uuid",
			true, "defaultLanguageId", true, "assetListEntryId", true,
			"groupId", true, "companyId", true, "userId", true, "userName",
			true, "createDate", true, "modifiedDate", true, "type", true,
	...
	protected AssetListEntry addAssetListEntry() throws Exception {
		...
		assetListEntry.setDefaultLanguageId(RandomTestUtil.randomString());
