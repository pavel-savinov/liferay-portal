...
import com.liferay.asset.list.model.AssetListEntryAssetEntryRelSoap;
...
public class AssetListEntryAssetEntryRelModelImpl extends BaseModelImpl<AssetListEntryAssetEntryRel>
	 ...
	 */
	public static AssetListEntryAssetEntryRel toModel(
		AssetListEntryAssetEntryRelSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		AssetListEntryAssetEntryRel model = new AssetListEntryAssetEntryRelImpl();

		model.setAssetListEntryAssetEntryRelId(soapModel.getAssetListEntryAssetEntryRelId());
	 ...
	 */
	public static List<AssetListEntryAssetEntryRel> toModels(
		AssetListEntryAssetEntryRelSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<AssetListEntryAssetEntryRel> models = new ArrayList<AssetListEntryAssetEntryRel>(soapModels.length);

		for (AssetListEntryAssetEntryRelSoap soapModel : soapModels) {
