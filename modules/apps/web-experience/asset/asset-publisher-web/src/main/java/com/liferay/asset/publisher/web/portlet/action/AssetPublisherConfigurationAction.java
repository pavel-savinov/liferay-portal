...
public class AssetPublisherConfigurationAction
	...
	@Reference(unbind = "-")
	protected void setAssetPublisherCustomizerRegistry(
		AssetPublisherCustomizerRegistry assetPublisherCustomizerRegistry) {

		_assetPublisherCustomizerRegistry = assetPublisherCustomizerRegistry;
	}
