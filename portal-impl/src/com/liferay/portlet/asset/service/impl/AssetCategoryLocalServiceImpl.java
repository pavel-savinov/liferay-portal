...
import com.liferay.asset.kernel.exception.InvalidCategoryException;
...
public class AssetCategoryLocalServiceImpl
	...
	public AssetCategory moveCategory(
		...
		if (categoryId == parentCategoryId) {
			throw new InvalidCategoryException(parentCategoryId, 2);
		}
		...
		if (parentCategoryId > 0) {
			...
			if (childrenCategories.contains(parentCategory)) {
				throw new InvalidCategoryException(categoryId, 1);
			}
		}
