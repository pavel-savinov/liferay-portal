...
public class AssetDisplayPageEntryLocalServiceWrapper
	...
	*/
	...
	@Override
	public int getAssetDisplayPageEntriesCount(long layoutPageTemplateEntryId) {
		return _assetDisplayPageEntryLocalService.getAssetDisplayPageEntriesCount(layoutPageTemplateEntryId);
	}
