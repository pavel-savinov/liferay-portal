...
public class FragmentCompositionPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newFragmentComposition.setFragments(RandomTestUtil.randomString());
		...
		Assert.assertEquals(
			existingFragmentComposition.getFragments(),
			newFragmentComposition.getFragments());
		Assert.assertEquals(
	...
	protected FragmentComposition addFragmentComposition() throws Exception {
		...
		fragmentComposition.setFragments(RandomTestUtil.randomString());
