...
import com.liferay.modern.site.building.fragment.model.impl.FragmentCollectionImpl;
import com.liferay.modern.site.building.fragment.model.impl.FragmentCollectionModelImpl;
 ...
 * @see com.liferay.modern.site.building.fragment.service.persistence.FragmentCollectionUtil
 * @generated
 */
@ProviderType
public class FragmentCollectionPersistenceImpl extends BasePersistenceImpl<FragmentCollection>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((fragmentCollection.getUuid() == null) ||
							!fragmentCollection.getUuid().equals(uuid) ||
							(fragmentCollection.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
	...
	protected FragmentCollection toUnwrappedModel(
		...
		fragmentCollectionImpl.setUuid(fragmentCollection.getUuid());
