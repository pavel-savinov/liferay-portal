...
public class AssetListEntryLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.asset.list.model.AssetListEntryLocalization fetchAssetListEntryLocalization(
		long assetListEntryId, String languageId) {
		return getService()
				   .fetchAssetListEntryLocalization(assetListEntryId, languageId);
	}
	...
	*/
	...
	public static com.liferay.asset.list.model.AssetListEntryLocalization getAssetListEntryLocalization(
		long assetListEntryId, String languageId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .getAssetListEntryLocalization(assetListEntryId, languageId);
	}

	public static java.util.List<com.liferay.asset.list.model.AssetListEntryLocalization> getAssetListEntryLocalizations(
		long assetListEntryId) {
		return getService().getAssetListEntryLocalizations(assetListEntryId);
	}
	...
	*/
	...
	public static com.liferay.asset.list.model.AssetListEntryLocalization updateAssetListEntryLocalization(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateAssetListEntryLocalization(assetListEntry,
			languageId, title, description);
	}

	public static java.util.List<com.liferay.asset.list.model.AssetListEntryLocalization> updateAssetListEntryLocalizations(
		com.liferay.asset.list.model.AssetListEntry assetListEntry,
		java.util.Map<String, String> titleMap,
		java.util.Map<String, String> descriptionMap)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateAssetListEntryLocalizations(assetListEntry, titleMap,
			descriptionMap);
	}
