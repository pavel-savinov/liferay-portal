...
public class FragmentEntryFinderImpl
	...
	public static final String COUNT_FC_BY_G_FCI_LIKEN =
		FragmentEntryFinder.class.getName() + ".countFC_ByG_FCI_LikeN";

	public static final String COUNT_FE_BY_G_FCI =
		FragmentEntryFinder.class.getName() + ".countFE_ByG_FCI";

	public static final String COUNT_FE_BY_G_FCI_LIKEN =
		FragmentEntryFinder.class.getName() + ".countFE_ByG_FCI_LikeN";

	public static final String FIND_FC_BY_G_FCI =
		FragmentEntryFinder.class.getName() + ".findFC_ByG_FCI";

	public static final String FIND_FC_BY_G_FCI_LIKEN =
		FragmentEntryFinder.class.getName() + ".findFC_ByG_FCI_LikeN";

	public static final String FIND_FE_BY_G_FCI =
		FragmentEntryFinder.class.getName() + ".findFE_ByG_FCI";

	public static final String FIND_FE_BY_G_FCI_LIKEN =
		FragmentEntryFinder.class.getName() + ".findFE_ByG_FCI_LikeN";
	...
	@Override
	public int countFC_FE_ByG_FCI_LikeN(
		...
		try {
			...
			sb.append(
				_customSQL.get(
					getClass(), COUNT_FC_BY_G_FCI_LIKEN, queryDefinition,
					FragmentCompositionImpl.TABLE_NAME));
			sb.append(") UNION ALL (");
			sb.append(
				_customSQL.get(
					getClass(), COUNT_FE_BY_G_FCI_LIKEN, queryDefinition,
					FragmentEntryImpl.TABLE_NAME));
			sb.append(StringPool.CLOSE_PARENTHESIS);
	...
	@Override
	public List<Object> findFC_FE_ByG_FCI_LikeN(
		long groupId, long fragmentCollectionId, String name,
		QueryDefinition<?> queryDefinition) {
		...
		try {
			...
			sb.append(
				_customSQL.get(
					getClass(), FIND_FC_BY_G_FCI_LIKEN, queryDefinition,
					FragmentCompositionImpl.TABLE_NAME));
			sb.append(") UNION ALL (");
			sb.append(
				_customSQL.get(
					getClass(), FIND_FE_BY_G_FCI_LIKEN, queryDefinition,
					FragmentEntryImpl.TABLE_NAME));
			sb.append(StringPool.CLOSE_PARENTHESIS);
