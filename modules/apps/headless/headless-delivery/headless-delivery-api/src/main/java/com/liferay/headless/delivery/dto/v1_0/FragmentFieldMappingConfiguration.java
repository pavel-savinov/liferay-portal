 ...
 */
@Generated("")
@GraphQLName("FragmentFieldMappingConfiguration")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FragmentFieldMappingConfiguration")
public class FragmentFieldMappingConfiguration {
	...
	public String toString() {
		...
		if (mappedEntryField != null) {
			...
			sb.append(_escape(mappedEntryField));

			sb.append("\"");
		}

		if (mappedEntryKey != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(_escape(mappedEntryKey));
	...
	@Schema(
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.FragmentFieldMappingConfiguration",
		name = "x-class-name"
	)
