...
page import="com.liferay.layout.admin.web.internal.display.context.SelectCollectionDisplayContext" %><%@
...
page import="com.liferay.layout.admin.web.internal.servlet.taglib.clay.SelectLayoutPageTemplateEntryMasterLayoutVerticalCard" %><%@
