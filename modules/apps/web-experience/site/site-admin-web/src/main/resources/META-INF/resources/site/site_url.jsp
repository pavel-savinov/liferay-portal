...
<aui:fieldset>
	...
	<liferay-ui:input-localized defaultLanguageId="<%= LocaleUtil.toLanguageId(themeDisplay.getSiteDefaultLocale()) %>" name="friendlyURL" xml="<%= HttpUtil.decodeURL(liveGroup.getFriendlyURLsXML()) %>" />
	...
	<c:if test="<%= liveGroup.hasStagingGroup() %>">
		...
		<liferay-ui:input-localized defaultLanguageId="<%= LocaleUtil.toLanguageId(themeDisplay.getSiteDefaultLocale()) %>" name="stagingFriendlyURL" xml="<%= HttpUtil.decodeURL(stagingGroup.getFriendlyURLsXML()) %>" />
	</c:if>
