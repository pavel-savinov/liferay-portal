...
public class FragmentCompositionModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"description", Types.VARCHAR}, {"fragments", Types.CLOB},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("fragments", Types.CLOB);
	...
	public static FragmentComposition toModel(
		...
		model.setFragments(soapModel.getFragments());
	...
	static {
		...
		attributeGetterFunctions.put(
			"fragments", FragmentComposition::getFragments);
		attributeSetterBiConsumers.put(
			"fragments",
			(BiConsumer<FragmentComposition, String>)
				FragmentComposition::setFragments);
		attributeGetterFunctions.put(
	...
	public Object clone() {
		...
		fragmentCompositionImpl.setFragments(getFragments());
	...
	public CacheModel<FragmentComposition> toCacheModel() {
		...
		fragmentCompositionCacheModel.fragments = getFragments();

		String fragments = fragmentCompositionCacheModel.fragments;

		if ((fragments != null) && (fragments.length() == 0)) {
			fragmentCompositionCacheModel.fragments = null;
		}
