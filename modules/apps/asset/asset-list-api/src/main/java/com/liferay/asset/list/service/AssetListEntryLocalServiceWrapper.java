...
public class AssetListEntryLocalServiceWrapper
	...
	*/
	...
	@Override
	public com.liferay.asset.list.model.AssetListEntryLocalization fetchAssetListEntryLocalization(
		long assetListEntryId, String languageId) {
		return _assetListEntryLocalService.fetchAssetListEntryLocalization(assetListEntryId,
			languageId);
	}
	...
	*/
	...
	@Override
	public com.liferay.asset.list.model.AssetListEntryLocalization getAssetListEntryLocalization(
		long assetListEntryId, String languageId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetListEntryLocalService.getAssetListEntryLocalization(assetListEntryId,
			languageId);
	}

	@Override
	public java.util.List<com.liferay.asset.list.model.AssetListEntryLocalization> getAssetListEntryLocalizations(
		long assetListEntryId) {
		return _assetListEntryLocalService.getAssetListEntryLocalizations(assetListEntryId);
	}
	...
	*/
	...
	@Override
	public com.liferay.asset.list.model.AssetListEntryLocalization updateAssetListEntryLocalization(
		com.liferay.asset.list.model.AssetListEntry assetListEntry,
		String languageId, String title, String description)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetListEntryLocalService.updateAssetListEntryLocalization(assetListEntry,
			languageId, title, description);
	}

	@Override
	public java.util.List<com.liferay.asset.list.model.AssetListEntryLocalization> updateAssetListEntryLocalizations(
		com.liferay.asset.list.model.AssetListEntry assetListEntry,
		java.util.Map<String, String> titleMap,
		java.util.Map<String, String> descriptionMap)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _assetListEntryLocalService.updateAssetListEntryLocalizations(assetListEntry,
			titleMap, descriptionMap);
	}
