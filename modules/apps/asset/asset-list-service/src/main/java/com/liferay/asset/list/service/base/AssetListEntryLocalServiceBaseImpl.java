...
public abstract class AssetListEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AssetListEntryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.asset.list.service.AssetListEntryLocalServiceUtil} to access the asset list entry local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AssetListEntry.class,
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(assetListEntryLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return assetListEntryLocalService.deleteAssetListEntry((AssetListEntry)persistedModel);
	}
	...
	public AssetListEntryLocalization fetchAssetListEntryLocalization(
		...
		return assetListEntryLocalizationPersistence.fetchByAssetListEntryId_LanguageId(assetListEntryId,
			languageId);
	}
	...
	public AssetListEntryLocalization getAssetListEntryLocalization(
		...
		return assetListEntryLocalizationPersistence.findByAssetListEntryId_LanguageId(assetListEntryId,
			languageId);
	}
	...
	public List<AssetListEntryLocalization> getAssetListEntryLocalizations(
		...
		return assetListEntryLocalizationPersistence.findByAssetListEntryId(assetListEntryId);
	}
	...
	public AssetListEntryLocalization updateAssetListEntryLocalization(
		...
		assetListEntry = assetListEntryPersistence.findByPrimaryKey(assetListEntry.getPrimaryKey());

		AssetListEntryLocalization assetListEntryLocalization = assetListEntryLocalizationPersistence.fetchByAssetListEntryId_LanguageId(assetListEntry.getAssetListEntryId(),
				languageId);

		return _updateAssetListEntryLocalization(assetListEntry,
			assetListEntryLocalization, languageId, title, description);
	}
	...
	public List<AssetListEntryLocalization> updateAssetListEntryLocalizations(
		...
		List<AssetListEntryLocalization> assetListEntryLocalizations = new ArrayList<AssetListEntryLocalization>(localizedValuesMap.size());

		for (AssetListEntryLocalization assetListEntryLocalization : assetListEntryLocalizationPersistence.findByAssetListEntryId(
				assetListEntry.getAssetListEntryId())) {
			String[] localizedValues = localizedValuesMap.remove(assetListEntryLocalization.getLanguageId());

			if (localizedValues == null) {
				assetListEntryLocalizationPersistence.remove(assetListEntryLocalization);
			}
			else {
				assetListEntryLocalization.setGroupId(assetListEntry.getGroupId());
				assetListEntryLocalization.setCompanyId(assetListEntry.getCompanyId());

				assetListEntryLocalization.setTitle(localizedValues[0]);
				assetListEntryLocalization.setDescription(localizedValues[1]);

				assetListEntryLocalizations.add(assetListEntryLocalizationPersistence.update(
						assetListEntryLocalization));
			}
		}

		long batchCounter = counterLocalService.increment(AssetListEntryLocalization.class.getName(),
		...
		for (Map.Entry<String, String[]> entry : localizedValuesMap.entrySet()) {
			...
			AssetListEntryLocalization assetListEntryLocalization = assetListEntryLocalizationPersistence.create(++batchCounter);

			assetListEntryLocalization.setAssetListEntryId(assetListEntry.getAssetListEntryId());
			assetListEntryLocalization.setGroupId(assetListEntry.getGroupId());
			assetListEntryLocalization.setCompanyId(assetListEntry.getCompanyId());
		...
		return assetListEntryLocalizations;
	}

	private AssetListEntryLocalization _updateAssetListEntryLocalization(
		...
		if (assetListEntryLocalization == null) {
			long assetListEntryLocalizationId = counterLocalService.increment(AssetListEntryLocalization.class.getName());

			assetListEntryLocalization = assetListEntryLocalizationPersistence.create(assetListEntryLocalizationId);
		...
		return assetListEntryLocalizationPersistence.update(assetListEntryLocalization);
	}
	 ...
	 */
	public AssetListEntryLocalService getAssetListEntryLocalService() {
	...
	/**
	 * Returns the asset list entry localization persistence.
	 *
	 * @return the asset list entry localization persistence
	 */
	public AssetListEntryLocalizationPersistence getAssetListEntryLocalizationPersistence() {
		return assetListEntryLocalizationPersistence;
	}

	/**
	 * Sets the asset list entry localization persistence.
	 *
	 * @param assetListEntryLocalizationPersistence the asset list entry localization persistence
	 */
	public void setAssetListEntryLocalizationPersistence(
		AssetListEntryLocalizationPersistence assetListEntryLocalizationPersistence) {
		this.assetListEntryLocalizationPersistence = assetListEntryLocalizationPersistence;
	}
	...
	@BeanReference(type = AssetListEntryLocalService.class)
	...
	@BeanReference(type = AssetListEntryLocalizationPersistence.class)
	protected AssetListEntryLocalizationPersistence assetListEntryLocalizationPersistence;
