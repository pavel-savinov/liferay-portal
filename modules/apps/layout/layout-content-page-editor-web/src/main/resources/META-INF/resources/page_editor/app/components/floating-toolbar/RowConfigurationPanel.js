...
export const RowConfigurationPanel = ({item}) => {
	...
	const numberOfColumnsConfig = getConfigViewportSize('numberOfColumns');
	const modulesPerRowConfig = getConfigViewportSize('modulesPerRow');
	const reverseOrderConfig = getConfigViewportSize('reverseOrder');
	const verticalAlignmentConfig = getConfigViewportSize('verticalAlignment');
